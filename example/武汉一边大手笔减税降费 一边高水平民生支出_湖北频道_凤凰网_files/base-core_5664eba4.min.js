...
!function (global) {
  ...
  function newContext(e) {
    ...
    function n(e, n, i) {
      var r, o, a, s, u, c, d, l, f, p, h, g = n && n.split("/"), b = g, m = k.map, v = m && m["*"];
      if (e && "." === e.charAt(0) && (n ? (b = g.slice(0, g.length - 1), e = e.split("/"), d = e.length - 1, k.nodeIdCompat && jsSuffixRegExp.test(e[d]) && (e[d] = e[d].replace(jsSuffixRegExp, "")), e = b.concat(e), t(e), e = e.join("/")) : 0 === e.indexOf("./") && (e = e.substring(2))), i && m && (g || v)) {
        ...
        !l && p && (l = p, f = h), l && (a.splice(0, f, l), e = a.join("/"))
      }
    ...
    function a(e, t, i, r) {
      var a, s, u, c, d = null, l = t ? t.name : null, f = e, p = !0, h = "";
      return e || (p = !1, e = "_@r" + (D += 1)), c = o(e), d = c[0], e = c[1], d && (d = n(d, l, r), s = getOwn(q, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
        return n(e, l, r)
      }) : n(e, l, r) : (h = n(e, l, r), c = o(h), d = c[0], h = c[1], i = !0, a = x.nameToUrl(h))), u = !d || s || i ? "" : "_unnormalized" + (L += 1), {
        prefix: d,
        name: h,
        parentMap: t,
        unnormalized: !!u,
    ...
    function f(e, t, n) {
      ...
      e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps, function (i, r) {
        var o = i.id, a = getOwn(E, o);
        !a || e.depMatched[r] || n[o] || (getOwn(t, o) ? (e.defineDep(r, q[o]), e.check()) : f(a, t, n))
      }), n[i] = !0)
    }

    function p() {
      var e, t, n = 1e3 * k.waitSeconds, o = n && x.startTime + n < (new Date).getTime(), a = [], s = [], u = !1,
        d = !0;
      if (!v) {
        if (v = !0, eachProp(C, function (e) {
          var n = e.map, c = n.id;
          if (e.enabled && (n.isDefine || s.push(e), !e.error)) if (!e.inited && o) r(c) ? (t = !0, u = !0) : (a.push(c), i(c)); else if (!e.inited && e.fetched && n.isDefine && (u = !0, !n.prefix)) return d = !1
    ...
    var v, y, x, w, _, k = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}},
      E = {}, C = {}, O = {}, S = [], q = {}, T = {}, M = {}, D = 1, L = 1;
    return w = {
      require: function (e) {
        return e.require ? e.require : e.require = x.makeRequire(e.map)
      }, exports: function (e) {
        return e.usingExports = !0, e.map.isDefine ? e.exports ? q[e.map.id] = e.exports : e.exports = q[e.map.id] = {} : void 0
      }, module: function (e) {
      ...
      init: function (e, t, n, i) {
          ...
          if (this.inited) {
            if (this.error) this.emit("error", this.error); else if (!this.defining) {
              if (this.defining = !0, this.depCount < 1 && !this.defined) {
                ...
                this.exports = r, this.map.isDefine && !this.ignore && (q[n] = r, req.onResourceLoad && req.onResourceLoad(x, this.map, this.depMaps)), l(n), this.defined = !0
              }
        ...
        this.depMaps.push(i), u(i, "defined", bind(this, function (i) {
          var r, o, d, f = getOwn(M, this.map.id), p = this.map.name,
            h = this.map.parentMap ? this.map.parentMap.name : null,
            g = x.makeRequire(e.parentMap, {enableBuildCallback: !0});
          return this.map.unnormalized ? (i.normalize && (p = i.normalize(p, function (e) {
          ...
          })), d = getOwn(E, o.id), void (d && (this.depMaps.push(o), this.events.error && d.on("error", bind(this, function (e) {
            this.emit("error", e)
          })), d.enable()))) : f ? (this.map.url = x.nameToUrl(f), void this.load()) : (r = bind(this, function (e) {
            this.init([], function () {
              return e
            }, null, {enabled: !0})
            ...
            i && (n = i), d && (useInteractive = !1), s(u), hasProp(k.config, t) && (k.config[o] = k.config[t]);
            try {
              req.exec(n)
            } catch (l) {
              return c(makeError("fromtexteval", "fromText eval for " + t + " failed: " + l, l, [t]))
            }
            d && (useInteractive = !0), this.depMaps.push(u), x.completeLoad(o), g([o], r)
      ...
      makeRequire: function (t, r) {
        function o(n, i, u) {
          var d, l, f;
          return r.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof n ? isFunction(i) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(w, n) ? w[n](E[t.id]) : req.get ? req.get(x, n, t, o) : (l = a(n, t, !1, !0), d = l.id, hasProp(q, d) ? q[d] : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (m(), x.nextTick(function () {
            m(), f = s(a(null, t)), f.skipMap = r.skipMap, f.init(n, i, u, {enabled: !0}), p()
          }), o)
        }
        ...
        return r = r || {}, mixin(o, {
          ...
          i(e), delete q[e], delete T[n.url], delete O[e], eachReverse(S, function (t, n) {
            t[0] === e && S.splice(n, 1)
  ...
  "use strict";
  var t = window;
  e.__old = t.glue, t.glue = e, t.__glue = e;
  var n = t.define;
  e.hasDefine = {}, t.define = function (t) {
    e.hasDefine[t] = t, n.apply(null, arguments)
  }, t.define.amd = {jQuery: !0};
  var i = Object.prototype.toString, r = function () {
  };
  "function" != typeof r.bind && (Function.prototype.bind = function (e) {
    ...
    version: "1.1.11",
    options: {comboServer: "http://localhost:9001/combo/", useComboServer: !1, prefix: "g-", attrPrefix: "g-attr-"},
    noConflict: function () {
      var t = e;
      return window.glue = e.__old, t
    },
    config: function (t) {
    ...
    capitalize: function (e) {
      return e.replace(/(^|\s)([a-z|A-Z])(\w*)/g, function (e, t, n, i) {
  ...
  function n(e, t, n) {
    var i = !0;
    if (e) {
      var r = 0, o = e.length, a = t[0], s = t[1], u = t[2];
      switch (t.length) {
        case 0:
  ...
  t.prototype.on = function (e, t, n) {
    var i, o, a;
    if (!t) return this;
    for (i = this.__events || (this.__events = {}), e = e.split(r); o = e.shift();) a = i[o] || (i[o] = []), a.push(t, n);
    return this
    ...
    for (e = e ? e.split(r) : o(i); a = e.shift();) if (s = i[a]) if (t || n) for (u = s.length - 2; u >= 0; u -= 2) t && s[u] !== t || n && s[u + 1] !== n || s.splice(u, 2); else delete i[a];
    return this
  }, t.prototype.trigger = function (e) {
    var t, i, o, a, s, u, c = [], d = !0;
    if (!(t = this.__events)) return this;
    for (e = e.split(r), s = 1, u = arguments.length; u > s; s++) c[s - 1] = arguments[s];
    for (; i = e.shift();) (o = t.all) && (o = o.slice()), (a = t[i]) && (a = a.slice()), d = n(a, c, this) && d, d = n(o, [i].concat(c), this) && d;
    return d
  ...
  function n(e) {
    var n, i;
    for (n in e) i = e[n], t.Mutators.hasOwnProperty(n) ? t.Mutators[n].call(this, i) : this.prototype[n] = i
  }

  function i(e) {
    return e.extend = t.extend, e.implement = n, e}
  ...
  t.create = function (e, r) {
    function a() {
      e.apply(this, arguments), this.constructor === a && this.initialize && this.initialize.apply(this, arguments)
    }

    return c(e) || (r = e, e = null), r || (r = {}), e || (e = r.Extends || t), r.Extends = e, e !== t && o(a, e, e.StaticsWhiteList), n.call(a, r), i(a)
  }, t.extend = function (e) {
    return e || (e = {}), e.Extends = this, t.create(e)
  }, t.Mutators = {
    Extends: function (e) {
      var t = this.prototype, n = a(e.prototype);
      o(n, t), n.constructor = this, this.prototype = n, this.superclass = e.prototype
  ...
  }, s = Object.prototype.toString, u = Array.isArray || function (e) {
  ...
  var t = (window, document), n = {
    ...
    col: ["table", "colgroup"],
    li: ["ul"]
  }, i = /<\s*([\w\:]+)/, r = {}, o = 0, a = "__ToDomId";
  for (var s in n) if (n.hasOwnProperty(s)) {
    var u = n[s];
    u.pre = "option" === s ? '<select multiple="multiple">' : "<" + u.join("><") + ">", u.post = "</" + u.reverse().join("></") + ">"
  }
  var c = function (e, t) {
    t = t || t;
    var s = t[a];
    s || (t[a] = s = ++o + "", r[s] = t.createElement("div")), e += "";
    var u, c, d, l, f = e.match(i), p = f ? f[1].toLowerCase() : "", h = r[s];
    if (f && n[p]) for (u = n[p], h.innerHTML = u.pre + e + u.post, c = u.length; c; --c) h = h.firstChild; else h.innerHTML = e;
  ...
  return e.dom = {toDom: c, createDocumentFragment: l, createTextNode: d}, e
}(glue || {}), define("F_WidgetBase/utils", [], function () {
  "use strict";
  var e = "{{", t = "}}", n = function (n) {
    for (var i, r, o, a = [], s = 0; ;) {
      if (o = n.indexOf(e, s), -1 === o) break;
      if (i = n.slice(s, o), i && a.push({value: i, expr: !1}), s = o + e.length, o = n.indexOf(t, s), -1 === o) break;
      i = n.slice(s, o), i && (i = i.split("."), r = i.shift(), i = i.join("."), a.push({
        value: i,
        scope: r,
        expr: !0
      })), s = o + t.length
    }
    return i = n.slice(s), i && a.push({value: i, scope: "", expr: !1}), a
  }, i = function (e, t) {
    for (var n, i = e, r = 0, o = t.length; o > r; r++) {
      if (n = t[r], !(n in e)) {
        var a = i.type + "组件中不存在" + t.join(".") + "属性,请检查";
  ...
  return {scanExpr: n, transContext: i}
}), window.glue = function (e) {
  function t(e) {
  ...
  function r(e, t, n) {
    for (var i = 0, r = e.length; r > i && t.call(e, e[i], i) !== !1; i++) ;
  }
  ...
  function o(e) {
    ...
    t = p.exec(e), r = t[1];
    var s = t[1].split(".");
    return "undefined" == typeof o && (o = r), s[0] = parseInt(s[0], 10) - 4, n = s.join("."), "undefined" == typeof i && (i = n), {
      browserVersion: o,
      browserMode: r,
      engineVersion: i,
      engineMode: n,
  ...
  function a(e) {
    if (c) try {
      var t = c.twGetRunPath.toLowerCase(), n = c.twGetSecurityID(f), i = c.twGetVersion(n);
  ...
  function s(e, r, o) {
    ...
    if (!a) return null;
    var s = {name: e, version: l, codename: ""}, u = t(a);
    if (a === !0) return s;
    if ("[object String]" === u) {
      if (-1 !== o.indexOf(a)) return s
    } else {
      if (n(a)) return a.hasOwnProperty("version") && (s.version = a.version), s;
      if (a.exec) {
        var c = a.exec(o);
        if (c) return c.length >= 2 && c[1] ? s.version = c[1].replace(/_/g, ".") : s.version = l, s
      }
    }
  }
  ...
  var c, d = {}, l = "-1", f = this, p = /\b(?:msie |ie |trident\/[0-9].*rv[ :])([0-9.]+)/,
    h = [["nokia", function (e) {
    ...
    }], ["pc", "windows"], ["ipad", "ipad"], ["ipod", "ipod"], ["iphone", /\biphone\b|\biph(\d)/], ["mac", "macintosh"], ["mi", /\bmi[ \-]?([a-z0-9 ]+(?= build))/], ["aliyun", /\baliyunos\b(?:[\-](\d+))?/], ["meizu", /\b(?:meizu\/|m)([0-9]+)\b/], ["nexus", /\bnexus ([0-9s.]+)/], ["huawei", function (e) {
    ...
    m = [["sg", / se ([0-9.x]+)/], ["tw", function (e) {
      ...
      try {
        if (c && (c.mxVersion || c.max_version)) return {version: c.mxVersion || c.max_version}
      } catch (t) {
      }
      return /\bmaxthon(?:[ \/]([0-9.]+))?/
    }], ["qq", /\bm?qqbrowser\/([0-9.]+)/], ["green", "greenbrowser"], ["tt", /\btencenttraveler ([0-9.]+)/], ["lb", function (e) {
      ...
      return {version: t || l}
    }], ["tao", /\btaobrowser\/([0-9.]+)/], ["fs", /\bcoolnovo\/([0-9.]+)/], ["sy", "saayaa"], ["baidu", /\bbidubrowser[ \/]([0-9.x]+)/], ["ie", p], ["mi", /\bmiuibrowser\/([0-9.]+)/], ["opera", function (e) {
      var t = /\bopera.+version\/([0-9.ab]+)/, n = /\bopr\/([0-9.]+)/;
      return t.test(e) ? t : n
    }], ["yandex", /yabrowser\/([0-9.]+)/], ["ali-ap", function (e) {
      return e.indexOf("aliapp") > 0 ? /\baliapp\(ap\/([0-9.]+)\)/ : /\balipayclient\/([0-9.]+)\b/
    }], ["ali-ap-pd", /\baliapp\(ap-pd\/([0-9.]+)\)/], ["ali-am", /\baliapp\(am\/([0-9.]+)\)/], ["ali-tb", /\baliapp\(tb\/([0-9.]+)\)/], ["ali-tb-pd", /\baliapp\(tb-pd\/([0-9.]+)\)/], ["ali-tm", /\baliapp\(tm\/([0-9.]+)\)/], ["ali-tm-pd", /\baliapp\(tm-pd\/([0-9.]+)\)/], ["chrome", / (?:chrome|crios|crmo)\/([0-9.]+)/], ["uc", function (e) {
    ...
    v = {name: "na", version: l}, y = function (e) {
      e = (e || "").toLowerCase();
      var t = {};
      u(e, h, function (e, n) {
        var i = parseFloat(n);
        t.device = {name: e, version: i, fullVersion: n}, t.device[e] = i
      }, t), u(e, g, function (e, n) {
        var i = parseFloat(n);
        t.os = {name: e, version: i, fullVersion: n}, t.os[e] = i
      }, t);
      var n = o(e);
      return u(e, b, function (e, i) {
        var r = i;
  ...
  if ("object" == typeof process && "[object process]" === process.toString()) {
    var x = module.require("./morerule");
    [].unshift.apply(h, x.DEVICES || []), [].unshift.apply(g, x.OS || []), [].unshift.apply(m, x.BROWSER || []), [].unshift.apply(b, x.ENGINE || [])
  } else {
    var w = navigator.userAgent || "", _ = navigator.appVersion || "", k = navigator.vendor || "";
    c = f.external, d = y(w + " " + _ + " " + k)
  }
  d.parse = y;
  var E = {type: "pc"}, C = navigator.userAgent, O = d.device.name, S = d.os.name, q = d.browser.name,
    T = "|pc|mac|na|",
    M = !!("ipad" === O || "android" === S && !C.match(/Mobile/) || "firefox" === q && C.match(/Tablet/)),
    D = !(M || !(T.indexOf("|" + O + "|") < 0) || "linux" === S);
  return M && (E.type = "pad"), D && (E.type = "mobile"), E.config = d, e.device = E, f.device = E, e
}(glue || {}), window.glue = function (e) {
  "use strict";
  var t, n = window, i = Object.defineProperty;
  try {
    i({}, "_", {value: "x"}), t = Object.defineProperties
  } catch (r) {
    i = function (e, t, n) {
  ...
  var s = function (t) {
    ...
    for (var l in i) "$" === l.substring(0, 1) || e.isFunction(i[l]) ? o[l] = i[l] : (d[l] = i[l], a[l] = function (t) {
      return function () {
        ...
        var c = arguments[0], d = u.$orgModel[t];
        if (c !== d) {
          if (e.isArray(d)) i = u[t], i.clear(), i.push.apply(i, c); else {
            if (!e.isObject(d)) {
              if (u.$orgModel[t] = c, a = u.$events[t], "undefined" != typeof a) for (r = 0; r < a.length; r++) o = a[r].callback, o.call(a[r].context, c);
              return
            }
            i = u[t];
            for (n in c) "$" === n.substring(0, 1) || "__const__" === n || "__data__" === n || "__proxy__" === n || "hasOwnProperty" === n || e.isFunction(c[n]) || (i[n] = c[n]);
            for (a = u.$events[t] || [], r = 0; r < a.length; r++) o = a[r].callback, o.call(a[r].context, c)
          }
    ...
    var f = n.VBArray && n.execScript ? function (e) {
      return e
    } : function (e) {
      var t = {};
      for (var n in e) t[n] = {get: e[n], set: e[n]};
      return t
    }, p = t(i, f(a), o);
    s.vmodel = p, p.$events = {}, p.$watch = function () {
    }, p.$unWatch = function () {
    }, p.$orgModel = d;
    var h = function (e, t, n) {
      "undefined" == typeof this.$events[e] && (this.$events[e] = []), this.$events[e].push({
        callback: t,
        context: n || this
      })
    }, g = function (t, n, i) {
      ...
      for (var u in this.$events) if (u === t || "*" === t) {
        for (r = this.$events[u], a = r.length - 1; a >= 0; a--) o = r[a], o.callback !== n && "*" !== n || o.context !== i && "*" !== i || r.splice(a, 1);
        0 === r.length && delete this.$events[u]
      }
    };
    return p.$unWatch = g.bind(p), p.$watch = h.bind(p), p
  }, c = function (e) {
    return e.$events = {}, e.$unWatch = function (e, t, n) {
      e = e || "*", t = t || "*", n = n || "*";
      var i, r, o;
      for (var a in this.$events) if (a === e || "*" === e) {
        for (i = this.$events[a], o = i.length - 1; o >= 0; o--) r = i[o], r.callback !== t && "*" !== t || r.context !== n && "*" !== n || i.splice(o, 1);
      ...
      var e = Array.prototype.push.apply(this, arguments), t = [].slice.call(arguments);
      return this.$fire("push", t), e
    }, e.pop = function () {
      var e = Array.prototype.pop.apply(this, arguments);
      return this.$fire("pop", e), e
    }, e.unshift = function () {
      var e = Array.prototype.unshift.apply(this, arguments), t = [].slice.call(arguments);
      return this.$fire("unshift", t), e
    }, e.shift = function () {
      var e = Array.prototype.shift.apply(this, arguments);
      return this.$fire("shift", e), e
    }, e.clear = function () {
      return this.length = 0, this.$fire("clear"), this
    }, e.unshift = function () {
      var e = Array.prototype.unshift.apply(this, arguments), t = [].slice.call(arguments);
      return this.$fire("unshift", t), e
    }, e.$fire = function (e) {
      var t, n = [].slice.call(arguments), i = this.$events[e];
      if ("undefined" != typeof i) for (var r = 0; r < i.length; r++) t = i[r], n.length > 1 ? t.callback.call(t.context, n[1]) : t.callback.call(t.context, n[1])
    }, e
  }, d = {define: s, defineArray: c};
  return e.modelFactory = d, e
}(glue || {}), window.glue = function (e) {
  "use strict";
  var t = {}, n = {}, i = 0;
  return e.extend(e, {
    createWidgetUuid: function () {
      return i++, "__glue_widget_" + i
    }, addWidget: function (n) {
      "undefined" == typeof n.uuid && (n.uuid = e.createWidgetUuid()), t[n.uuid] = n
    }, removeWidget: function (e) {
      "string" != typeof e && (e = e.uuid);
      var n = t[e];
      delete t[e], n.destroy()
    }, getWidget: function (e) {
      return "string" != typeof e && (e = e.uuid), t[e]
  ...
  "use strict";
  var t = window, n = {}, i = new e.Events, r = /\s+/;
  return e.extend(e, {
    observer: function (e, n, o) {
      o = o || t;
      var a, s = e.split(r);
      i.on(e, n, o);
      for (var u = 0, c = s.length; c > u; u++) a = this.getMessage(s[u]), a.length > 0 && n.apply(o, a[a.length - 1])
  ...
  return e.extend(e, {
    ...
    depWidgetList: {},
    widgetRegist: function (t, n, i, r, o, a, s) {
      ("undefined" == typeof o || null === o) && (o = 1), e.regWidgetAllNames[i] = i, "undefined" == typeof e.regWidgetComboedNames[i] && "undefined" == typeof e.hasDefine[i] && (e.regWidgetUnComboNames[i] = i);
      var u = {
        id: n,
        priority: o,
        nexts: [],
        ...
        createTime: "",
        start: function () {
          u.startTime = (new Date).valueOf(), s = s || e;
          try {
            require([i], function (e) {
              var i = new e(s, n);
              i.create(t, a), u.instance = i, u.createTime = (new Date).valueOf()
            })
          } catch (r) {
      ...
      "undefined" != typeof r && null !== r ? ("undefined" == typeof e.depWidgetList[r] && (e.depWidgetList[r] = []), e.depWidgetList[r].push(u)) : ("undefined" == typeof e.regWidgetPriorityList[o] && (e.regWidgetPriorityList[o] = []), e.regWidgetPriorityList[o].push(u)), e.regWidgetList[n] = u
    }
  }), e
}(glue || {}), window.glue = function (e) {
  "use strict";
  var t = document, n = t.documentElement;
  e.extend(e, {
    scan: function (e) {
      e = e || n, i(e)
    }
  ...
  var i = function (t) {
    var n = e.options, r = t.getAttribute(n.prefix + "cid"), o = t.getAttribute(n.prefix + "cname"),
      a = t.getAttribute(n.prefix + "priority"), s = t.getAttribute(n.prefix + "depId"),
      u = t.getAttribute(n.prefix + "isRegister");
    if (e.isString(r) && e.isString(o) && "registered" !== u) return t.setAttribute("g-isRegister", "registered"), void e.widgetRegist(t, r, o, s, a);
    for (var c = t.firstChild; c;) {
      var d = c.nextSibling;
      1 === c.nodeType && i(c), c = d
    }
  };
  return e
}(glue || {}), window.glue = function (e) {
  "use strict";
  var t = document, n = null, i = [];
  e.extend(e, {
    comboQuestList: [], isComboing: !1, isRunRegWidgets: !1, run: function () {
      r(), u(), e.options.useComboServer ? a(function () {
        c()
      }) : c()
    }, notifyDepExce: function (t) {
      var n = e.regWidgetList[t.uuid];
      if ("undefined" != typeof n) {
        var i = n.priority, r = e.regWidgetPriorityList[i], o = n.nexts;
        r.push.apply(r, o), n.nexts = [], o.length > 0 && e.isRunRegWidgets === !1 && c()
      }
    }
  });
  var r = function () {
    var t;
    for (var n in e.depWidgetList) t = e.regWidgetList[n], "undefined" != typeof e.regWidgetList[n] && (t.nexts = t.nexts.concat(e.depWidgetList[n]), e.depWidgetList[n] = [], t.instance && t.instance.isDependWidgetRun === !0 && e.notifyDepExce(t.instance))
  }, o = function (e) {
    return e.join(",")
  }, a = function (n) {
    if (e.isComboing === !0) return void e.comboQuestList.push(n);
    e.isComboing = !0;
    var i = [], r = [], a = e.options, u = t.head || t.getElementsByTagName("head")[0];
    for (var c in e.regWidgetComboedNames) r.push(c);
    for (var d in e.regWidgetUnComboNames) i.push(d), e.regWidgetComboedNames[d] = d;
    if (e.regWidgetUnComboNames = {}, 0 === i.length) return n && n(), void s();
    i.sort(), r.sort();
    var l = a.comboServer + "?c=" + encodeURIComponent(o(i)) + "&f=" + encodeURIComponent(o(r)),
      f = e.debug.debugConfigGet();
    l += f.isCompress === !1 ? "&isCompress=false" : "&isCompress=true", l = l + "&device=" + e.device.type;
    var p = t.createElement("script");
    p[e.W3C ? "onload" : "onreadystatechange"] = function () {
      (e.W3C || /loaded|complete/i.test(p.readyState)) && (e.isComboing = !1, n && n(), s())
    }, p.onerror = function () {
      alert("装载失败！")
    }, p.src = l, u.insertBefore(p, u.firstChild)
  }, s = function () {
    var t;
  ...
  var n = function (i, r, o) {
    var a = r.split("."), s = a.shift();
    return e.isDefined(i) && null !== i ? (o = i, i = i[s]) : i = t[s], 0 === a.length ? o && o.$watch ? {
      value: i,
      $watch: function (e, t) {
        return function (n) {
          t.$watch(e, n)
    ...
    } : {value: i} : n(i, a.join("."), i)
  };
  return e
}(glue || {}), define("F_glue", [], function () {
  return __glue
}), window.glue = function (glue) {
  "use strict";
  var win = window, doc = document, getDom = function (e) {
    ...
    var e, t = 0;
    for (var n in glue.regWidgetList) e = glue.regWidgetList[n].createTime, e > t && (t = e);
    return t
  }, getBeginTime = function () {
    var e, t = (new Date).valueOf();
    for (var n in glue.regWidgetList) e = glue.regWidgetList[n].startTime || t, t > e && (t = e);
    return t
  }, sortList = function () {
    var e = [];
    for (var t in glue.regWidgetList) e.push(glue.regWidgetList[t]);
    return e.sort(function (e, t) {
      var n = (new Date).valueOf(), i = e.startTime || n, r = t.startTime || n;
      return i - r
    }), e
    ...
    var t, n = [];
    for (var i in e) t = e[i], "string" == typeof t && (t = '"' + t.replace(/["]/gi, "\\windflowers").replace(/windflowers/gi, '"') + '"'), n.push('"' + i + '": ' + t);
    return "{" + n.join(",") + "}"
    ...
    var n = simpleStringToJson(t), i = win.requirejs.config;
    win.requirejs.config = function (t) {
      var r, o = t.paths;
      if ("undefined" != typeof o) for (var a in o) r = o[a], "undefined" != typeof n[r] ? t.paths[a] = n[r] : e === !1 && (t.paths[a] = r.replace(/\.min/, ""));
      i.call(win.requirejs, t)
    }
  }, createComboLink = function (e, t) {
    var n = t || "http://localhost:9001/";
    e = simpleStringToJson(e), e = e || [], n = n + "combo?c=" + encodeURIComponent(e.join(",")) + "&isDebug=true&device=" + glue.device.type, document.write("<script src=" + n + "></script>")
  }, getCookie = function (e) {
    var t, n, i = e + "=", r = doc.cookie, o = r.indexOf(i);
    return o > -1 ? (t = r.indexOf(";", o), n = -1 === t ? r.substring(o + i.length) : r.substring(o + i.length, t), n = decodeURIComponent(n)) : n = "", n
    ...
    init: function () {
      var e = win.location.href.indexOf("f_debug=true") > -1, t = this.debugConfigGet();
      e && addEventListener(win, "load", function () {
      ...
      var o = {isLocal: e, isCompress: t, localUrl: n || "", pathMaps: i || "", compMaps: r || ""},
      ...
      t.innerHTML = n, doc.body.appendChild(t);
      var i = getDom("f_debugBoxShowHide"), r = getDom("f_debugBoxIn"), o = getDom("f_debug_bt1"),
        a = getDom("f_debug_bt2"), s = getDom("f_debug_bt3"), u = getDom("f_debug_bt4"), c = getDom("f_debug_bt5"),
        d = getDom("f_debug_isLocal"), l = getDom("f_debug_isCompress"), f = getDom("f_debug_localUrl"),
        p = getDom("f_debug_pathMaps"), h = getDom("f_debug_compMaps");
      "" !== e && (d.checked = e.isLocal, l.checked = !e.isCompress, f.value = e.localUrl, p.value = e.pathMaps, h.value = e.compMaps), i.onclick = function () {
        ...
        debug.debugConfigSet(d.checked, !l.checked, f.value, p.value, h.value), alert("调试配置保存成功，请刷新页面查看效果")
      }, a.onclick = function () {
        debug.debugConfigClear(), d.checked = !1, l.checked = !1, f.value = "", p.value = "", h.value = "", alert("调试设置已清除，请刷新页面查看效果")
      }, s.onclick = function () {
      ...
      var e, t = glue.regWidgetList, n = doc.createElement("div");
      n.setAttribute("style", "position: fixed; _position: absolute; background: #FFF; z-index:2147483647; bottom: 5px; right: 5px;"), n.setAttribute("id", "taskerViewList");
      var i = '<table cellspacing="0" cellpadding="3" border="1">';
      i += "<thead><tr><th>组件名</th><th>组件类型</th><th>优先级</th><th>注册时间</th><th>初始化时间</th><th>完成时间</th></tr>";
      for (var r in t) e = t[r], i += "<tr>", i += '<td style="width: 200px;">' + e.id + "</td>", i += '<td style="width: 200px;">' + e.cname + "</td>", i += "<td>" + e.priority + "</td>", i += "<td>" + formatTime(e.regTime) + "</td>", i += "<td>" + formatTime(e.startTime) + "</td>", i += "<td>" + formatTime(e.createTime) + "</td>", i += "</tr>";
      i += "</table>", i += "<button onclick=\"document.body.removeChild(document.getElementById('taskerViewList'))\">关闭</button>", doc.body.appendChild(n), n.innerHTML = i
    }, drawTimeLine: function () {
      var e, t, n = sortList(), i = getBeginTime(), r = getEndTime(), o = r - i, a = o > 0 ? 600 / o : 0,
        s = document.createElement("div");
      s.setAttribute("style", "position: fixed; _position: absolute; background: #FFF; z-index:2147483647; bottom: 5px; right: 5px;"), s.setAttribute("id", "taskerTimeLine");
      var u = '<table cellspacing="0" cellpadding="3" border="1">';
      u += "<thead><tr><th>组件名</th><th>优先级</th><th>注册时间</th><th>时间轴</th></tr>";
      for (var c, d, l, f, p = 0, h = n.length; h > p; p++) e = n[p], "" !== e.startTime ? (c = e.startTime - i, d = a * c) : (d = 0, c = 0), "" !== e.createTime ? (l = e.createTime - e.startTime, f = a * l, f = 1 > f ? 1 : f) : (f = 0, l = 0), t = e.id, u += "<tr>", u += "<td>" + t + "</td>", u += "<td>" + e.priority + "</td>", u += "<td>" + formatTime(e.regTime) + "</td>", u += "<td>", u += '<div style="display: inline-block; height: 10px; background: #CCC; width: ' + d + 'px" title="' + c + '"></div>', u += '<div style="display: inline-block; height: 10px; background: #C60; width: ' + f + 'px" title="' + l + '"></div>', u += "</td>", u += "</tr>";
      u += "</table>", u += "<button onclick=\"document.body.removeChild(document.getElementById('taskerTimeLine'))\">关闭</button>", document.body.appendChild(s), s.innerHTML = u
    }
  };
  return glue.extend(glue, {debug: debug}), glue.debug.init(), glue
}(glue || {}), define("F_WidgetBase", ["F_glue", "F_WidgetBase/utils"], function (e, t) {
  "use strict";
  var n = window, i = document, r = function () {
  }, o = e.Class.create({
    initialize: function (t, n) {
      ...
      this.isCreate = !1, this.isDependWidgetRun = !1, this.uuid = n || e.createWidgetUuid(), e.checkUuid(this.uuid) && (e.regUuid(this.uuid), this.parent = t, this.parent.addWidget(this), this.widgets = {})
    },
    create: function (e, t) {
    ...
    mixModel: function (t, i) {
      i = i.substring(2);
      var r = i.split("."), o = n[r.shift()], a = r.join("."), s = this,
        u = "|__const__|__data__|__proxy__|hasOwnProperty|";
      if ("" === a) for (a in o) "undefined" != typeof a && !/^[$]/.test(a) && u.indexOf("|" + a + "|") < 0 && e.resolveObject(o, a, function (e) {
        return function (t) {
          s.bibind(e, t)
        }
      }(t + "." + a)); else e.resolveObject(o, a, function (e) {
        return function (t) {
          s.bibind(e, t)
        }
      }(t))
    ...
    bibind: function (n, i) {
      ...
      o[n] = i.value, e.isFunction(i.$watch) && (i.$watch(function (e) {
        return function (t) {
          o[e] = "undefined" == typeof t ? "" : t
        }
      }(n)), o.$watch && o.$watch(n, function (e) {
        return function (t) {
          e.$set(t)
        }
      }(i)))
    ...
    resolveVariables: function () {
      if (this.ownerNode) {
        var n = this, i = function (r) {
          if (3 === r.nodeType) {
            for (var o = r.nodeValue, a = t.scanExpr(o), s = e.dom.createDocumentFragment(), u = 0; u < a.length; u++) {
              var c = a[u], d = e.dom.createTextNode(c.value);
              c.expr && e.resolveObject(n[c.scope], c.value, function (t) {
                d.nodeValue = t.value, e.isFunction(t.$watch) && !function (e) {
                  t.$watch(function (t) {
    ...
    getWidget: function (e) {
      return "string" != typeof e && (e = e.uuid), this.widget[e]
    },
    getAllWidget: function () {
      return this.widgets
    },
    notify: function () {
      ...
      t.push(this.uuid, this.type), "undefined" != typeof e && e.notify.apply(e, t)
    },
  ...
  return e.Events.mixTo(o), o.version = "1.1.11@", o.type = "widgetBase", o
});